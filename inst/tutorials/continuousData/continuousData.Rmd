...
Change the outcome (left hand side of `~` is the continuous outcome) to be `Height` and the right hand side (the binary factor) to be `Gender` to test height differences in males vs females.
