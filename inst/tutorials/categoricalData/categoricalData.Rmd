...
question("How did the top left cell change for the chi-matrix when you changed the filtering criteria?",
  answer("It got larger,.", correct=TRUE, message="Yes, correct."),
  answer("It got smaller, ")
)
```
...
question("Write up your results by selecting from the following statements:",
  answer("For our cohort of under 60 women", correct=TRUE, message="Compare our p-value to our alpha."),
  answer("we found an association between wearing colors and death", correct=TRUE, message="Go back and look at the proportions."), 
    answer("we found an association between smoking and death", correct=TRUE, message="Go back and look at the proportions."),
  answer("this association was significant with a p-value of 0.01")
...
summary(is.na(bmi_diabetes_raw))
```
