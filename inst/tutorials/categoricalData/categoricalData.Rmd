...
## Statistical Testing on Association: Chi-Squared Test
...
We're going to do a little calculation using R. 

```{r }
under60 <- Whickham %>% filter(age < 60) %>%
  select(smoker, outcome) %>% table

##these are the observed values  
under60

##we can calculate expected values using chisq.test()
chisq60 <- chisq.test(under60)

## show expected values
chisq60$expected

## show observed - expected
chisq60$observed - chisq60$expected
```
