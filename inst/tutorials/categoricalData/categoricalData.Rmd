...
> Alternative hypothesis (Ha): there is a difference between the proportion between smokers 
> and non-smokers.
...
Every statistic has an underlying model of randomness. 
...
There is a straightforward interpretation to the p-value.

Number in our null that are equal to our rare case / Total Number of cases. 
